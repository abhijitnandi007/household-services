export default {
    template: `
        <div class="container mt-4">
            <h2 class="text-center">Your Service Requests Overview</h2>
    ...
    methods: {
        ...
        renderStatusChart() {
            ...
            new Chart(ctx, {
                type: "bar",
                data: {
                    labels: ["Total Requests", "Completed", "Pending", "Rejected"],
                    datasets: [{
                        label: "Number of Requests",
                        data: [this.totalRequests, this.totalCompleted, this.totalPending, this.totalRejected],
